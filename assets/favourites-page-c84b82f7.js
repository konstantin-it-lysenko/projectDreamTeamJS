import{n as h,a as T,A,h as B}from"./loader-bcb9049c.js";function I(e){return e.map(({_id:t,name:s,burnedCalories:r,bodyPart:a,target:o})=>`<li><div class="favor-exercises-card" data-id="${t}">
