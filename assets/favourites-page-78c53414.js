import{n as h,a as T,A,h as B}from"./loader-ad3a5d9d.js";function I(e){return e.map(({_id:t,name:s,burnedCalories:r,bodyPart:a,target:o})=>`<li><div class="favor-exercises-card" data-id="${t}">
