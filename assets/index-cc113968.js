...
background-size: cover;
	background-position: center;'
		...
		</li>`}var oe="Expected a function",Y=0/0,Me="[object Symbol]",$e=/^\s+|\s+$/g,De=/^[-+]0x[0-9a-f]+$/i,Ce=/^0b[01]+$/i,Ne=/^0o[0-7]+$/i,Pe=parseInt,He=typeof M=="object"&&M&&M.Object===Object&&M,Ae=typeof self=="object"&&self&&self.Object===Object&&self,Oe=He||Ae||Function("return this")(),_e=Object.prototype,je=_e.toString,Ue=Math.max,Re=Math.min,_=function(){return Oe.Date.now()};function Fe(e,t,n){var s,i,r,c,a,l,d=0,u=!1,L=!1,H=!0;if(typeof e!="function")throw new TypeError(oe);t=ee(t)||0,D(n)&&(u=!!n.leading,L="maxWait"in n,r=L?Ue(ee(n.maxWait)||0,t):r,H="trailing"in n?!!n.trailing:H);function A(o){var m=s,x=i;return s=i=void 0,d=o,c=e.apply(x,m),c}function fe(o){return d=o,a=setTimeout(I,t),u?A(o):c}function ge(o){var m=o-l,x=o-d,Z=t-m;return L?Re(Z,r-x):Z}function V(o){var m=o-l,x=o-d;return l===void 0||m>=t||m<0||L&&x>=r}function I(){var o=_();if(V(o))return X(o);a=setTimeout(I,ge(o))}function X(o){return a=void 0,H&&s?A(o):(s=i=void 0,c)}function pe(){a!==void 0&&clearTimeout(a),d=0,s=l=i=a=void 0}function ye(){return a===void 0?c:X(_())}function O(){var o=_(),m=V(o);if(s=arguments,i=this,l=o,m){if(a===void 0)return fe(l);if(L)return a=setTimeout(I,t),A(l)}return a===void 0&&(a=setTimeout(I,t)),c}return O.cancel=pe,O.flush=ye,O}function We(e,t,n){var s=!0,i=!0;if(typeof e!="function")throw new TypeError(oe);return D(n)&&(s="leading"in n?!!n.leading:s,i="trailing"in n?!!n.trailing:i),Fe(e,t,{leading:s,maxWait:t,trailing:i})}function D(e){var t=typeof e;return!!e&&(t=="object"||t=="function")}function ze(e){return!!e&&typeof e=="object"}function Ke(e){return typeof e=="symbol"||ze(e)&&je.call(e)==Me}function ee(e){if(typeof e=="number")return e;if(Ke(e))return Y;if(D(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=D(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=e.replace($e,"");var n=Ce.test(e);return n||Ne.test(e)?Pe(e.slice(2),n?2:8):De.test(e)?Y:+e}var Ve=We;async function F(e="Body parts",t,n,s){const i=document.querySelector(".categories-list"),r=document.querySelector('button[data-page="middle"]'),c=document.querySelector('button[data-page="next"]');t===1?(r.disabled=!0,c.disabled=!0):t===2?c.disabled=!0:(r.disabled=!1,c.disabled=!1),s.forEach(a=>{a.classList.remove("active")}),[...s].forEach(a=>{a.innerHTML.trim()===String(n).trim()&&a.classList.add("active")});try{const a=await j(e,n);i.innerHTML=R(a.results)}catch{}}async function ce(e,t,n,s,i){const r=document.querySelector(".exercises-list"),c=document.querySelector('button[data-exer="middle"]'),a=document.querySelector('button[data-exer="next"]');n===1?(c.disabled=!0,a.disabled=!0):n===2?a.disabled=!0:(c.disabled=!1,a.disabled=!1),i.forEach(l=>{l.classList.remove("active")}),[...i].forEach(l=>{l.innerHTML.trim()===String(s).trim()&&l.classList.add("active")});try{const l=await re(e,t,s);r.innerHTML=U(l.results)}catch{}}const Xe={catsList:document.querySelector(".categories-list"),exercisesList:document.querySelector(".exercises-list"),catFilterList:document.querySelector(".cat-filter-list"),catPaginationList:document.querySelector(".cat-pagination-list"),exerPaginationList:document.querySelector(".exer-pagination-list"),exercisesTitleSpan:document.querySelector(".exercises-title-span"),catFilterInput:document.querySelector(".cat-filter-input")},{catsList:E,exercisesList:S,catFilterList:Ze,catPaginationList:P,exerPaginationList:B,exercisesTitleSpan:le,catFilterInput:T}=Xe,y=P.querySelectorAll("button[data-page]"),k=B.querySelectorAll("button[data-exer]");let h="Body parts",f="bodypart",g="",de=[],v=1,w=1,b=1,C=1;E.addEventListener("click",Je);Ze.addEventListener("click",Ge);S.addEventListener("click",tt);T.addEventListener("input",Ve(Ye,300));P.addEventListener("click",Qe);B.addEventListener("click",et);B.classList.add("is-hidden");j().then(e=>{v=e.totalPages,E.insertAdjacentHTML("beforeend",R(e.results)),F(h,v,b,y)}).catch(e=>{console.error(e),be.Notify.failure(e)});async function Ge(e){if(e.target.nodeName!=="BUTTON")return;switch(te(),h=e.target.dataset.name,E.classList.remove("is-hidden","d-none"),P.classList.remove("is-hidden","d-none"),S.classList.add("is-hidden","d-none"),B.classList.add("is-hidden","d-none"),T.value="",document.querySelectorAll(".cat-filter-btn").forEach(n=>n.classList.remove("active")),e.target.classList.add("active"),h){case"Muscles":f="muscles";break;case"Equipment":f="equipment";break;case"Body parts":f="bodypart";break}try{const n=await j(h,b);v=n.totalPages,b=1;const s=n.results.filter(({filter:i})=>i===h);le.innerHTML="",T.hidden=!0,E.innerHTML=R(s),y.forEach((i,r)=>i.innerHTML=r+1),F(h,v,b,y)}catch{}finally{ne()}}async function Je(e){te();try{g=e.target.closest(".categories-item").dataset.bodyPart;const t=await re(f,g);S.innerHTML=U(t.results),le.innerHTML=`<span class="exercises-title-span-page">/</span> ${g}`;const n=t.perPage;w=t.totalPages,C=1,k.forEach((s,i)=>s.innerHTML=i+1),ce(f,g,w,C,k),E.classList.add("is-hidden","d-none"),P.classList.add("is-hidden","d-none"),S.classList.remove("is-hidden","d-none"),B.classList.remove("is-hidden","d-none"),T.hidden=!1,de=await qe(f,g,n,w)}catch{}finally{ne()}}function Qe(e){if(e.target.nodeName!=="BUTTON")return;const t=e.target;b=t.innerHTML,t.dataset.page==="next"&&t.innerHTML<v?y.forEach(n=>{const s=Number(n.innerHTML);n.innerHTML=s+1}):t.dataset.page==="prev"&&t.innerHTML>1?y.forEach(n=>{const s=Number(n.innerHTML);n.innerHTML=s-1}):t.classList.add("active"),F(h,v,b,y)}function Ye(e){let t=T.value.toLowerCase().trim("");const n=de.filter(({name:i})=>i.includes(t)),s="<span class='exer-not-found'>Sorry, there is no data matching your search query.</span>";S.innerHTML=n.length===0?s:U(n)}function et(e){if(e.target.nodeName!=="BUTTON")return;const t=e.target;C=t.innerHTML,t.dataset.exer==="next"&&t.innerHTML<w?k.forEach(n=>{const s=Number(n.innerHTML);n.innerHTML=s+1}):t.dataset.exer==="prev"&&t.innerHTML>1?k.forEach(n=>{const s=Number(n.innerHTML);n.innerHTML=s-1}):t.classList.add("active"),ce(f,g,w,C,k)}function tt(e){const t=e.target.nodeName;if(t==="BUTTON"||t==="svg"||t==="use"){const n=e.target.closest(".exercises-item").dataset.exerciseId;ve(e,n)}}const{BASE_URL:nt,SUBSCR_EDPOINT:it}=N;function st(e){return q.post(`${nt}${it}`,e,{})}const ue=document.querySelector(".js-footer-form");ue.addEventListener("submit",at);function at(e){e.preventDefault();const n=document.querySelector('input[type="email"]').value;if(!rt(n))return $.Notify.failure("Invalid email address was entered.");st({email:n}).then(i=>{const r=i.data.message;$.Notify.success(r)}).catch(i=>{const r=i.response.data.message;i.response.status===409&&$.Notify.warning("Subscription already exists"),i.response.status===400&&$.Notify.warning(r)}),ue.reset()}function rt(e){return/^[\w\.-]+@[a-zA-Z\d\.-]+\.[a-zA-Z]{2,}$/.test(e)}const ot={root:null,rootMargin:"0px",threshold:0},me=document.querySelector(".footer_logo_icon"),ct=document.querySelector(".footer_title_span"),lt=new IntersectionObserver(dt,ot);lt.observe(me);function dt(e,t){e.forEach(n=>{n.isIntersecting&&(G.to(me,{duration:2,opacity:1,x:0,rotationX:360}),G.to(ct,{duration:2,opacity:1}))})}function ut(e){return e.map(t=>{const{name:n,linkedin:s,github:i}=t;return` <li class="team-item">
