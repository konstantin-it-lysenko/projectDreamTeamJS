import{n as f,a as p,A as w,h as b}from"./loader-4e7798ab.js";function E(e){return e.map(({_id:t,name:s,burnedCalories:r,bodyPart:o,target:n})=>`<li><div class="favor-exercises-card" data-id="${t}">
